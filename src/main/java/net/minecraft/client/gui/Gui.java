...
public class Gui
{
    ...
    protected void drawGradientRect(int left, int top, int right, int bottom, int startColor, int endColor)
    {
        ...
        worldrenderer.func_181662_b(right, top, (double)this.zLevel).func_181666_a(f1, f2, f3, f).func_181675_d();
        worldrenderer.func_181662_b(left, top, (double)this.zLevel).func_181666_a(f1, f2, f3, f).func_181675_d();
        worldrenderer.func_181662_b(left, bottom, (double)this.zLevel).func_181666_a(f5, f6, f7, f4).func_181675_d();
        worldrenderer.func_181662_b(right, bottom, (double)this.zLevel).func_181666_a(f5, f6, f7, f4).func_181675_d();
        tessellator.draw();
